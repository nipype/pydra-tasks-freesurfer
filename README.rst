...
.. image:: https://github.com/nipype/pydra-freesurfer/actions/workflows/pythonpackage.yml/badge.svg
   :target: https://github.com/nipype/pydra-freesurfer/actions/workflows/pythonpackage.yml
...
.. image:: https://img.shields.io/pypi/v/pydra-freesurfer.svg
   :target: https://pypi.python.org/pypi/pydra-freesurfer/
   :alt: Latest Version


This package contains a collection of Pydra task interfaces for the freesurfer toolkit.
...
Automatically generated tasks can be found in the `pydra.tasks.freesurfer.auto` package.
...
`pydra.tasks.freesurfer.v*` packages, corresponding to the version of the freesurfer toolkit
...
If the test passes you should then edit the `pydra/tasks/freesurfer/v<tool-version>/__init__.py` file
